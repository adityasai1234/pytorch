...
class StatefulPRNG:
    ...
    Example::
        ...
        g = torch.random.StatefulPRNG(42)
    ...
    def uniform(
        ...
        *shape,
        ...
        result = uniform(
            self._key, *shape, low=low, high=high, dtype=dtype,
            device=self._key.device, portable=portable,
        )
    ...
    def normal(
        ...
        *shape,
        ...
        result = normal(
            self._key, *shape, mean=mean, std=std, dtype=dtype,
            device=self._key.device, portable=portable,
        )
